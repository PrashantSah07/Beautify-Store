...
const Foundation = () => {
    ...
    const images = [
        { src: 'https://img.freepik.com/premium-vector/3d-realistic-foundation-bottle-cosmetic-product-liquid-cream-texture-skincare_444188-1498.jpg?uid=R167577231&ga=GA1.1.25709270.1745646915&semt=ais_hybrid&w=740' },
        ...
        { src: 'https://img.freepik.com/premium-vector/elegant-foundation-ads_281653-10235.jpg?uid=R167577231&ga=GA1.1.25709270.1745646915&semt=ais_hybrid&w=740' },
        { src: 'https://img.freepik.com/premium-photo/bottle-serum-with-gold-cap-leaves-pearl-beige-background_1085076-10649.jpg?uid=R167577231&ga=GA1.1.25709270.1745646915&semt=ais_hybrid&w=740' },
        { src: 'https://img.freepik.com/premium-vector/foundation-makeup-advertising-design-template-catalog-with-concealer-bb-cream-packaging-tube_136277-345.jpg?uid=R167577231&ga=GA1.1.25709270.1745646915&semt=ais_hybrid&w=740' }
    ]
    ...
    const brands = ['w3llpeople', 'colourpop', 'deciem', 'rejuva minerals', 'marienatie', 'nyx', 'glossier', 'fenty', 'dior', 'iman', 'benefit', 'smashbox', 'covergirl', 'cargo cosmetics', 'maybelline', 'sante', 'physicians formula', 'e.l.f.', 'revlon', 'almay', "l'oreal", 'pure anada', 'milani', 'marcelle', 'dr. hauschka', 'mineral fusion', 'annabelle'];

    const category = ['liquid', 'powder', 'cream', 'mineral', 'contour', 'bb_cc', 'highlighter', 'concealer'];

    const tag_list = ['water free', 'cruelty free', 'alcohol free', 'oil free', 'silicone free', 'Vegan', 'Gluten Free', 'EWG Verified', 'purpicks', 'Hypoallergenic', 'No Talc', 'CertClean', 'Canadian', 'Natural'];
    ...
    return (
        <div className='max-w-[2000px] mx-auto '>
            ...
            <div className='lg:px-20 sm:px-10 px-5 py-10 flex flex-col gap-10'>
                <h2 className='text-3xl font-semibold'>Foundation Products</h2>
                ...
                <div className='flex justify-center items-center gap-3 flex-wrap'>
                    ...
                    <div className='flex justify-center items-center px-2 py-2 rounded-lg shadow-sm'>
                        <input type="range" min="0" max="49.0" value={priceRange} onChange={(e) => setPriceRange(Number(e.target.value))} />

...
const Mascara = () => {
    ...
    const images = [
        { src: 'https://img.freepik.com/free-photo/top-view-mascara-with-copy-space_23-2149096687.jpg?uid=R167577231&ga=GA1.1.25709270.1745646915&semt=ais_hybrid&w=740' },
        { src: 'https://img.freepik.com/free-photo/top-view-mascara-with-brushes_23-2149096686.jpg?uid=R167577231&ga=GA1.1.25709270.1745646915&semt=ais_hybrid&w=740' },
        { src: 'https://img.freepik.com/free-vector/social-media-cover-template-beauty-cosmetics_23-2150409107.jpg?uid=R167577231&ga=GA1.1.25709270.1745646915&semt=ais_hybrid&w=740' },
        { src: 'https://img.freepik.com/premium-photo/close-up-cable-against-yellow-background_1048944-24270637.jpg?uid=R167577231&ga=GA1.1.25709270.1745646915&semt=ais_hybrid&w=740' },
        { src: 'https://img.freepik.com/premium-vector/3d-realistic-banner-makeup-products-like-lipstick-mascara-brush-eyeliner-foundation-cream_444188-1661.jpg?uid=R167577231&ga=GA1.1.25709270.1745646915&semt=ais_hybrid&w=740' }
    ]
    ...
    const brands = ['green people', 'zorah', 'lotus cosmetics usa', 'marienatie', 'nyx', 'glossier', 'physicians formula', 'dior', 'iman', 'benefit', 'smashbox', 'covergirl', 'maybelline', 'e.l.f.', "l'oreal", 'pure anada', 'marcelle', 'dr. hauschka', 'mineral fusion', "c'est moi", 'almay', 'wet n wild', 'suncoat', 'pacifica'];

    const tag_list = ['EWG Verified', 'purpicks', 'Hypoallergenic', 'No Talc', 'Organic', 'USDA Organic', 'CertClean', 'EcoCert', 'Gluten Free', 'Natural', 'Canadian', 'Vegan'];
    ...
    return (
        <div className='max-w-[2000px] mx-auto '>
            ...
            <div className='lg:px-20 sm:px-10 px-5 py-10 flex flex-col gap-10'>
                <h2 className='text-3xl font-semibold'>Mascara Products</h2>
                ...
                <div className='flex justify-center items-center gap-3 flex-wrap'>
                    ...
                    <div className='flex justify-center items-center px-2 py-2 rounded-lg shadow-sm'>
                        <input type="range" min="0" max="33.0" value={priceRange} onChange={(e) => setPriceRange(Number(e.target.value))} />
